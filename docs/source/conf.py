...
# bbp_code_package documentation build
...
from bbp_code_package import __version__ as release
import sys

#sys.path.append('../../src/bbp_code_package/nodes/extraction/cell_data_load_process.py')

# -- Project information -----------------------------------------------------

project = "bbp_code_package"
...
htmlhelp_basename = "bbp_code_packagedoc"
...
latex_documents = [
    (
        master_doc,
        "bbp_code_package.tex",
        "bbp_code_package Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "bbp_code_package",
        "Project bbp_code_package codebase.",
        "Data-Science",
    )
]
